namespace Caitlyn.ViewModels
{
    ...
    public class SelectProjectsViewModel : ViewModelBase
    {
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="existingProjects"/> is <c>null</c>.</exception>
        ...
        {
            get { return "Select the projects you want to link"; }
        }
        ...
        {
            get { return GetValue<List<Project>>(AvailableProjectsProperty); }
        ...
        {
            get { return GetValue<Project>(RootProjectProperty); }
        ...
        /// </summary>
        public static readonly PropertyData RootProjectProperty = RegisterProperty("RootProject", typeof(Project), null,
            (sender, e) => ((SelectProjectsViewModel)sender).OnRootProjectChanged());
        ...
        {
            get { return GetValue<ObservableCollection<ProjectSelection>>(SelectableProjectsProperty); }
            set { SetValue(SelectableProjectsProperty, value); }
        }
        ...
        {
            get { return GetValue<bool>(RemoveMissingFilesProperty); }
            set { SetValue(RemoveMissingFilesProperty, value); }
        }
        ...
        {
            SelectableProjects.ReplaceRange(from project in AvailableProjects
                                            select new ProjectSelection(project));
            ...
            if (RootProject != null)
            {
                ...
                {
                    var rightProject = (from selectableProject in SelectableProjects
