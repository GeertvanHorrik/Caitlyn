// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IVisualStudioService.cs" company="Catel development team">
...
namespace Caitlyn.Services
{
    ...
    public interface IVisualStudioService
    {
        ...
        /// </summary>
        /// <returns>All the root projects of the current solution. If there is no current solution, this method will return an empty array.</returns>
        Project[] GetAllRootProjects();
